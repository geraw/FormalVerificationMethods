...
<b>אינטואיציה מרכזית:</b> קיפאון מתרחש כאשר המערכת כולה נמצאת במצב טרמינלי,
אף שלפחות רכיב אחד נמצא מקומית במצב לא־טרמינלי. התרחיש הטיפוסי הוא המתנה הדדית בין רכיבים.
</div>
...
- לכן המערכת הגלובלית היא טרמינלית כבר בצעד הראשון.
</div>

<div class="bg-blue-50 border border-blue-200 rounded p-5">
<div class="font-bold mb-3">למה זו לא "סיום תקין"?</div>
...
חמישה פילוסופים יושבים סביב שולחן עגול. בין כל שני שכנים יש מקל אכילה אחד בלבד.
...
- פילוסופים: $P_0,\dots,P_4$
- מקלות: $S_0,\dots,S_4$
- כל החישובים הם מודולו $5$
...
- למשל: המקלות הראשון, השלישי והחמישי בכיוון אחד, והשאר בכיוון ההפוך.
...
- במערכות מקביליות, מצב טרמינלי הוא בדרך כלל חשוד.
...
עקבות ותכונות זמן לינאריות שבעזרתן נוכל לנסח ולבדוק גם חופש מקיפאון.
</div>
