import{f as _,aj as u,e as n,g as t,t as s,C as c,F as h,ag as f,z as g,o as l,aa as v,d as x,j as b}from"../modules/vue-Czdd3CBZ.js";import{a as y,u as N,y as m}from"../index-BcwjfePn.js";import{_ as k}from"./NoteDisplay.vue_vue_type_style_index_0_lang-rBW4lHoL.js";import"../modules/shiki-C4atB7Vu.js";const w={id:"page-root"},L={class:"m-4"},T={class:"mb-10"},V={class:"text-4xl font-bold mt-2"},j={class:"opacity-50"},B={class:"text-lg"},C={class:"font-bold flex gap-2"},H={class:"opacity-50"},S={key:0,class:"border-main mb-8"},A=_({__name:"print",setup(z){const{slides:d,total:p}=y();u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
