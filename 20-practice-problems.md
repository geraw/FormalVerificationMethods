...
<div class="text-center text-[18px] mt-3">
...
<span dir="ltr"><KatexInline math="\mathrm{Words}(\Box\Phi)\;\subsetneq\;\mathrm{Words}(\Diamond\Box\Phi)" /></span>.
<ul class="list-disc list-inside mt-1 space-y-1">
<li><b>הכלה (</b><span dir="ltr"><KatexInline math="\subseteq" /></span><b>):</b> אם <span dir="ltr"><KatexInline math="\sigma\models\Box\Phi" /></span> אז <span dir="ltr"><KatexInline math="\Phi" /></span> מחזיקה מרגע 0 לנצח, ובפרט <span dir="ltr"><KatexInline math="\sigma\models\Diamond\Box\Phi" /></span>.</li>
<li><b>הכלה ממש (</b><span dir="ltr"><KatexInline math="\neq" /></span><b>):</b> המילה <span dir="ltr"><KatexInline math="\sigma=B\cdot A^\omega" /></span> מקיימת <span dir="ltr"><KatexInline math="\Diamond\Box\Phi" /></span> (מרגע 1 ואילך <span dir="ltr"><KatexInline math="\Phi" /></span> מחזיקה לנצח) אך <span dir="ltr"><KatexInline math="\sigma\not\models\Box\Phi" /></span> (<span dir="ltr"><KatexInline math="\Phi" /></span> נכשלת בצעד 0). כלומר: אותה תכונת שמורה <span dir="ltr"><KatexInline math="\Box\Phi" /></span> היא תת-קבוצה ממש של תכונת ההתמדה <span dir="ltr"><KatexInline math="\Diamond\Box\Phi" /></span>, ולכן השתיים לא שוות כשפות.</li>
</ul>
</div>
