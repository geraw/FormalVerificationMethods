...
# אנימציה: ריצת הרובוט על גרף התוכנית

<RobotProgramGraphWalkthrough />
...
- **דוגמה:**
  נניח ש-$\alpha$ היא הפעולה $x := y + 5$, כאשר $x, y$  הם משתנים שלמים. 
  <br>
...
- יש לקרוא זאת כך: **אם** הטענה מעל הקו (ההנחה) מתקיימת, **אז** גם הטענה מתחת לקו (המסקנה) מתקיימת.
